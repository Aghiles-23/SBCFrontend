      ...
      theme={theme}>
        ...
        <Box sx={{ width: "100%", mt: 6 }}>
          <Grid container spacing={2} mt={0.5} justifyContent="center" sx={{ cursor: "pointer" }}>
            ...
            <Grid item xs={6} sm={4} md={2}>
              <Card
                onClick={() => handleClickOpen1("/offresEntreprise/Exploitation")}
                elevation={5}
                sx={{
                  height: "90%",
                  // @ts-ignore
            ...
            <Grid item xs={6} sm={4} md={2}>
              <Card
                onClick={() => handleClickOpen1("/offresEntreprise/PrommotionImmobiliere")}
                elevation={5}
                sx={{
                  height: "90%",
                  // @ts-ignore
              ...
              >
                <CardContent sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 2.5 }}>
                  ...
                  <Typography sx={{px:'25%'}} gutterBottom variant="h5" fontSize={16} fontWeight={600}>
